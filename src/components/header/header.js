            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div className="d-flex text-white">
                    {!userLoggedIn ? (
                        ...
                        <div>
                            <img src={require(`../avatar/${pseudo}.jpg`)} alt='avatar' width='50' height='40' className='bg-white rounded-circle mr-2 border border-white' /><span className='text-white mr-2'>{pseudo}</span>
                            |
